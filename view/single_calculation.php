			...
			<table>
				...
				<td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#"><img src="../design/pictures/edit.png" onclick="document.getElementById('FileInput').type='file';document.getElementById('FileInput').disabled=false;documet.getElementByID('FileInput').name = 'dokument'; = new type(arguments);"></a>

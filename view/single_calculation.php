                    ...
                    <form action="<?php echo $GLOBALS["ROOT_URL"]; ?>/rechnung/anzeige" method="POST"  enctype="multipart/form-data">
                        <div id="blockleft">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>Kosten</td>
                                    <td><input type="text" id="kosten" name="kosten" style="width:302px;" value="<?php echo $rg->getKosten(); ?>" disabled/></td>
                                ...
                                <tr>
                                    <td>Dokument</td>
                                    <td>
                                        <input id="dokument" type="text" name="dokument" style="width:302px;" value="<?php echo $rg->getDokument(); ?>" disabled/>
                                    </td>
                                    <td>

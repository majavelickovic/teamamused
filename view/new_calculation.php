        ...
        <div id="whiteblock">
			...
			<table>
				...
				<td>
                        ...
                        <tr>
                            <td>Kosten</td>
                            <td><input type="number" name="kosten" style="width:302px;" min="0" max="999999"/></td>
                        </tr>
                        <tr>
                            <td>Beschreibung</td>
                        ...
                        <tr>
                            <td>Dokument</td>
                            <td>
                                <input id="dokument" type="file" name="dokument" style="width:302px;" accept="application/pdf"/>
                            </td>
                        </tr>
                        <tr>

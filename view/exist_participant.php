                ...
                <div id="blockleft">
                    ...
                    <form id="searchForm" action="<?php echo $GLOBALS["ROOT_URL"]; ?>/teilnehmer/bestehend" method="POST">
                        <table>
                            ...
                            <tr>
                                <td>Teilnehmer-ID</td>
                                <td><input type="text" name="teilnehmer_id" size="40px" value="<?php echo $_POST['teilnehmer_id'] ?>" /></td>
                            </tr>
                            <tr>
                                <td>Vorname</td>
                                <td><input type="text" name="vorname" size="40px" value="<?php echo $_POST['vorname'] ?>" /></td>
                            </tr>
                            <tr>
                                <td>Nachname</td>
                                <td><input type="text" name="nachname" size="40px" value="<?php echo $_POST['nachname'] ?>" /></td>
                            </tr>
                            <tr>

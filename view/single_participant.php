                ...
                <form action="<?php echo $GLOBALS["ROOT_URL"]; ?>/teilnehmer/anzeige" method="POST">
                    <div id="blockleft">
                        ...
                        <table>
                            ...
                            <tr>
                                <td colspan="3" align="center"><input type="button" class="button" value="zur&uuml;cksetzen" onclick="reloadOriginalParticipant()"/><input type="submit" class="button" value="speichern" /><input type="button" class="button" value="zur&uuml;ck" onclick="window.location.href='/teilnehmer/bestehend'" /></td></br>
                                <td colspan="3" align="center"><input type="button" class="button" value="drucken" onclick="printParticipant()" /></td>
                            </tr>
                        </table>
                    </div>
                    <div id="blockright">

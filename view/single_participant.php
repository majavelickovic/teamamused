                ...
                <form action="<?php echo $GLOBALS["ROOT_URL"]; ?>/teilnehmer/anzeige" method="POST">
                    <div id="blockleft">
                        ...
                        <table>
                            ...
                            <tr>
                                <td colspan="2" align="center"><input type="button" class="button" value="drucken" onclick="printParticipant()" />  <input type="button" class="button" value="zur&uuml;ck" onclick="onclick='readParticipant'/></td>
                            </tr>
                            <tr>

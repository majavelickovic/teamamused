                ...
                <div id="block">
                    ...
                    <form action="<?php echo $GLOBALS["ROOT_URL"]; ?>/reise/anzeige" method="POST">
                        ...
                        <div id="blockright">
                            ...
                            <table>
                                <tr>
                                    <td colspan="2" align="center"><input type="button" class="button" value="drucken" onclick="printJourney()" />  <input type="button" class="button" value="zur&uuml;ck" href="reise/bestehend" </td>
                                </tr>
                                <tr>

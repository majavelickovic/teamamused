                    ...
                    <form action="<?php echo $GLOBALS["ROOT_URL"]; ?>/reise/anzeige" method="POST">
                        <div id="blockleft">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>Datum von</td>
                                    <td><input type="text" id="datum_start" name="datum_start" style="width:305px;" value="<?php echo $reise->getDatum_start(); ?>" disabled/></td>
                                ...
                                <tr>
                                    <td>Datum bis</td>
                                    <td><input type="text" id="datum_ende" name="datum_ende" style="width:305px;" value="<?php echo $reise->getDatum_ende(); ?>" disabled/></td>
